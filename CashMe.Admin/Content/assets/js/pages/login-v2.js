...
$(function () {
    ...
    if ($('body').data('page') == 'login') {
       ...
       // $('#submit-form, #submit-password').click(function (e) {
            ...
            //l.start();
            //setTimeout(function () {
            //    window.location.href = "/he-thong/xin-chao.html";
            //}, 2000);
        //});
        $.backstretch(["/Content/assets_new/global/images/gallery/login.jpg"],
        {
            fade: 600,
            duration: 4000
        });
        ...
        $('#slide-cb').change(function () {
            if ($(this).is(":checked")) {
                $.backstretch(["/Content/assets_new/global/images/gallery/login4.jpg", "/Content/assets_new/global/images/gallery/login3.jpg", "/Content/assets_new/global/images/gallery/login2.jpg", "/Content/assets_new/global/images/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
