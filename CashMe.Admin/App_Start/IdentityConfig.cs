...
namespace CashMe.Admin
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            client.Credentials = new NetworkCredential("cashmesolution@gmail.com", "12345_abc");

            return client.SendMailAsync("cashmesolution@gmail.com", message.Destination, message.Subject, message.Body);
        }
    }
